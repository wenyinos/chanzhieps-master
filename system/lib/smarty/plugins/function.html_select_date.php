    ...
    if ($display_months) {
        ...
        for ($i = 1; $i <= 12; $i++) {
            ...
            $_text = isset($month_names) ? smarty_function_escape_special_chars($month_names[ $i ]) :
                ($month_format === '%m' ? $_val : date(str_replace('%', '', $month_format), $_month_timestamps[ $i ]));
            $_value = $month_value_format === '%m' ? $_val : date(str_replace('%', '', $month_value_format), $_month_timestamps[ $i ]);
